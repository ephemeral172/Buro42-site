...
const benefits = [
  {
    ...
    description: 'Использую подход Vibe Coding для быстрой проверки идей и гипотез.',
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description: 'Архитектура, логика безопасности и критические части всегда под моим контролем.',
  },
];
